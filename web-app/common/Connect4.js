...
Connect4.place_token = function(player, column_index, row_index, board){
    return  R.update(
        column_index,
...
Connect4.setup_board = function(board){
...
/*
piped implementation of initial board set up 

Connect4.setup_board_topright= function(board){
    return  R.update(
        4,
        R.update(4, 2, board[4]),
        board
    );
}

Connect4.setup_board_bottomleft= function(board){
    return  R.update(
        3,
        R.update(3, 2, board[3]),
        board
    );
}

Connect4.setup_board_bottomright= function(board){
    return  R.update(
        4,
        R.update(3, 1, board[4]),
        board
    );
}

Connect4.setup_board_topleft = function(board){
    return  R.update(
        3,
        R.update(4, 1, board[3]),
        board
    );
}

Connect4.setup_board_piped = function(board){
    board =  R.pipe(
        Connect4.setup_board_bottomleft,
        Connect4.setup_board_topright,
        Connect4.setup_board_bottomright,
        Connect4.setup_board_topleft,
    )(board)
    return board
}*/
 ...
 */
 Connect4.ply = function (token, column_index, row_index, board) {
